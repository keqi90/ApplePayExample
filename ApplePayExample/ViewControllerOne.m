...
//  原作者Demo：https://github.com/SummertimSadness/ApplePayDemo

#import "ViewControllerOne.h"
#import <PassKit/PassKit.h>                                 //用户绑定的银行卡信息
#import <PassKit/PKPaymentAuthorizationViewController.h>    //Apple pay的展示控件
#import <AddressBook/AddressBook.h>                         //用户联系信息相关
@interface ViewControllerOne ()<PKPaymentAuthorizationViewControllerDelegate>
{
...
- (UIButton *)payButton
{
    if (!_payButton) {
        ...
        payButton.bounds = CGRectMake(0, 0, 150, 50);
        payButton.center = CGPointMake(CGRectGetWidth(self.view.frame) * 0.5, CGRectGetHeight(self.view.frame) * 0.8);
        [self.view addSubview:payButton];
        payButton.layer.cornerRadius = 25.0f;
        ...
        [payButton addTarget:self action:@selector(buyNow:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)buyNow:(UIButton *)button {
    ...
    payRequest.merchantIdentifier = @"merchant.com.iwevon.applepay";  //申请的merchantID
